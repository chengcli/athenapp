...
# PT output (PTOUTPUT or NO_PTOUTPUT)
SET_IF_EMPTY(PT_OPTION "NO_PTOUTPUT")
...
if(NON_BAROTROPIC_EOS EQUAL 1)
  math(EXPR NHYDRO_VARIABLES "5 + ${NMASS}")
else()
  math(EXPR NHYDRO_VARIABLES "4 + ${NMASS}")
endif()
...
math(EXPR NUMBER_PASSIVE_SCALARS "${NCHEM}")
